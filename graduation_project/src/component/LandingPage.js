						...
						<div className="universities">
							<div className="uni-details">
								...
								<p>
									...
									printer took a galley of type and scrambled
									it to make a type specimen book. It has
									survived not only five centuries Lorem Ipsum
									...
									not only five centuries Lorem Ipsum is
				...
				<AboutUs>
					...
					<div className="text">
						...
						<p>
							...
							only five centuries Lorem Ipsum is simply dummy text
...
const Universities = styled.section`
	display: flex;
	padding: 50px 30px;
	flex-direction: column;
	gap: 60px;
